...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strlen($title) < 3) {
        ...
        if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
            // Insert recipe into database as 'draft'
            try {
                $stmt = $pdo->prepare("
            ...
            <div class="col-md-10">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <!-- Category dropdown (right column) -->
                        <div class="col-md-4">
                            <div class="mb-3">
